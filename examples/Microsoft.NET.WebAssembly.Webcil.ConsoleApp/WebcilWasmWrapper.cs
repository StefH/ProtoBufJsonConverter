...
public class WebcilWasmWrapper
{
    ...
    public static
        ...
        {
            
        };
    ...
    private static
        ...
        {
            0x00, 0x1b, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x02, 0x14, 0x02, 0x00, 0x01, 0x00, 0x07, 0x64, 0x65, 0x73,
            0x74, 0x50, 0x74, 0x72, 0x01, 0x02, 0x00, 0x01, 0x64, 0x01, 0x01, 0x6e
        };
    ...
    public const uint SegmentCodeSize = 1;
    ...
    public const uint WebcilPayloadInternalAlignment = 4;
    ...
    private void WriteDataSection(BinaryWriter writer)
    {
        ...
        uint payloadOffset = (uint)s_wasmWrapperPrefix.Length + 1 + (uint)putativeULEBDataSectionSize.Length +
                             dataSectionSize;
        ...
        if (putativeULEBDataSectionSize.Length != ulebSectionSize.Length)
            throw new InvalidOperationException(
                "adding padding would cause data section's encoded length to chane"); // TODO: fixme: there's upto one extra byte to encode the section length - take away a padding byte.
        ...
        {
            throw new Exception($"predicted offset {payloadOffset}, actual position {writer.BaseStream.Position}");
        }
    ...
    {
        var newValue = AlignTo(value, align);
